...
if ($actressDisplayName === '' || is_invalid_actress_name($actressDisplayName) || $dmmId === '' || str_starts_with($dmmId, 'name:')) {
    require __DIR__ . '/404.php';
}
...
$pageDescription = mb_strimwidth($actressDisplayName . 'の出演作品一覧。SOKUMIRUで人気の' . $actressDisplayName . '作品をチェック。', 0, 150, '…', 'UTF-8');
